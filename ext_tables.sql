CREATE TABLE tx_nrrepurpose_domain_model_job (
    ...
    want_exec_summary smallint unsigned DEFAULT 1 NOT NULL,
    want_faq smallint unsigned DEFAULT 1 NOT NULL,
    want_social_post smallint unsigned DEFAULT 1 NOT NULL,
    want_newsletter smallint unsigned DEFAULT 1 NOT NULL,
